...
class CAxisLabels0 : public COleDispatchDriver
{
public:
	CAxisLabels0(){} // 调用 COleDispatchDriver 默认构造函数
	CAxisLabels0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CAxisLabels0(const CAxisLabels0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
